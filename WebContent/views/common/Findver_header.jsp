		...
		<div>
			<div id="main">
				...
				<div id="modal">
					...
					<a href="/Semi/views/member/MemberJoinForm.jsp" class="content" id="join">회원가입</a> &nbsp; <a
				...
				<div id="loginmodal" style="display: none; color: #555555;">
					...
					<div class="find_join">
						<a href="" class="find_1" style="font-size: 13px; color: #464646;">아이디
							/ 비밀번호 찾기</a> | <a href="" class="find_2"
							style="color: #464646; font-size: 13px">회원가입</a>
					</div>
				</div>
		...
		<div id="topMenu">
			<ul>
				<li class="topMenuLi"><a href="#" class="menuLink">예매</a>
					<ul class="submenu">
						<div>
							<li><a href="/Semi/views/reservation/reservation.jsp">예매하기</a></li>
							<li><a href="/Semi/views/movie/movieTime.jsp"
								onclick="timetable();">상영시간</a></li>
						</div>
					</ul></li>
