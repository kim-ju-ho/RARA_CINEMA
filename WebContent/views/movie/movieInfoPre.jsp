...
<div>
	<div id="wrapper1">
        ...
        <div id="icbutton">
            <div id="minfo">
                <button id="minfobtn" onclick="location.href='/Semi/moviepre.mo?no=<%=mv.getMovieNo()%>'"> 영화 정보 버튼</button>
            </div>
            <div id="coment"> 
        ...
        <div id="storyFrame">
            ...
            <div id="gender">
                ...
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        var data = google.visualization.arrayToDataTable([["Gender", "Rating"], ["Fmale", 50], ["Male", 50]]);
