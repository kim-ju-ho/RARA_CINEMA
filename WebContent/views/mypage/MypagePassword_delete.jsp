  			...
  			data:{
  				...
  				if(pwd==userpwd){
  					...
  					if(confirm("정말 탈퇴하시겠습니까?")){
   	    			 ...
   	    			 window.location.href = "/Semi/Delete.me";
   	    			 window.location.href = "/Semi/views/mypage/MypageDelete.jsp";
   				    return true;
   				  	}else{
   				    return false;
   				    return;
