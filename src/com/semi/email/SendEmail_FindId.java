...
/**
 * Servlet implementation class SendEmail_FindId
 */
@WebServlet("/SendEmail_findId.me")
public class SendEmail_FindId extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SendEmail_FindId() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      String userName = request.getParameter("userName");
		...
		// 머야 이름하고 이메일 비교
		  ...
		  Member findUser = new MemberService().findId(userName,userEmail);
