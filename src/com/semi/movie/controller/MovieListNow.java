...
/**
 * Servlet implementation class MovieListNow
 */
@WebServlet("/movieList.now")
public class MovieListNow extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    list = ms.selectListMore(currentPage, limit);
